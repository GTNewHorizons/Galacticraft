        ...
        if (!Loader.isModLoaded(Constants.MOD_ID_NEW_HORIZONS_CORE_MOD)) {
            ...
            RecipeUtil.addRecipe(
                    ...
                    new Object[] { "TVS", "FWS", "PXO", 'T',
                            ...
                            new ItemStack(GCItems.basicItem, 1, 10), 'W', new ItemStack(MarsItems.marsItemBasic, 1, 6),
                            'O', new ItemStack(GCBlocks.oxygenCompressor, 1, 0), 'P',
            ...
            RecipeUtil.addRecipe(
                    ...
                    new Object[] { "TVT", "FWF", "CXO", 'T',
                            ...
                            GCItems.oxygenVent, 'F', new ItemStack(GCBlocks.oxygenPipe, 1, 0), 'X',
                            new ItemStack(GCItems.basicItem, 1, 10), 'W', new ItemStack(MarsItems.marsItemBasic, 1, 6),
                            'O', new ItemStack(GCBlocks.oxygenCompressor, 1, 0), 'C',
            ...
            RecipeUtil.addRecipe(
                    ...
                    new Object[] { "TVT", "FWF", "BXB", 'T',
                            ...
                            GCItems.oxygenVent, 'F', new ItemStack(GCBlocks.oxygenPipe, 1, 0), 'X',
                            new ItemStack(GCItems.basicItem, 1, 10), 'W', new ItemStack(MarsItems.marsItemBasic, 1, 6),
                            'B', new ItemStack(GCItems.basicItem, 1, 6) });
            ...
            RecipeUtil.addRecipe(
                    ...
                    new Object[] { "XYX", "XZX", "XYX", 'X', deshPlate, 'Y',
                            new ItemStack(MarsItems.marsItemBasic, 1, 3), 'Z', Items.bed });
            ...
            RecipeUtil.addRecipe(
                    ...
                    new Object[] { "ZVZ", "YXY", "ZWZ", 'V', new ItemStack(GCItems.basicItem, 1, 19), 'W',
                            new ItemStack(GCBlocks.aluminumWire, 1, 0), 'X', new ItemStack(GCItems.basicItem, 1, 14),
                            'Y', deshPlate, 'Z', deshIngot });
            ...
            CraftingManager.getInstance().addShapelessRecipe(
                    new ItemStack(MarsItems.carbonFragments, 8, 0),
                    new ItemStack(Items.coal, 1, 0));

            CraftingManager.getInstance().addShapelessRecipe(
                    new ItemStack(MarsItems.carbonFragments, 4, 0),
            ...
            RecipeUtil
                    .addRecipe(new ItemStack(MarsItems.marsItemBasic, 1, 1), new Object[] { "X", "X", 'X', deshIngot });
            ...
            FurnaceRecipes.smelting().func_151394_a(
                    new ItemStack(MarsBlocks.marsBlock, 1, 0),
                    new ItemStack(GCItems.basicItem, 1, 3),
                    1.0F);
            FurnaceRecipes.smelting().func_151394_a(
                    new ItemStack(MarsBlocks.marsBlock, 1, 1),
