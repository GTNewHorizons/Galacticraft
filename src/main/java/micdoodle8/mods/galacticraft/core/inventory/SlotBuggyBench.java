...
public class SlotBuggyBench extends Slot {
    ...
    public boolean isItemValid(ItemStack itemStack) {
        ...
        } else if (this.index >= 8 && this.index <= 11 && Loader.isModLoaded(Constants.MOD_ID_GREGTECH)) {
        ...
        } else if (this.index >= 17 && this.index <= 24 && Loader.isModLoaded(Constants.MOD_ID_GREGTECH)) {
            return itemStack.getItem() == GameRegistry.findItem(Constants.MOD_ID_GREGTECH, "gt.metaitem.01")
